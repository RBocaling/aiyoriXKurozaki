        ...
        <div className="container mx-auto px-6 flex flex-col items-center">
          ...
          >
            <img
              ...
              className="w-[200px] md:w-[300px] mx-auto mb-3"
            />
              ...
              <div className="flex items-center justify-center w-auto  gap-3 mb-6">
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 10px ${gen.color}`,
                  }}
                  animate={{ scale: [1, 1.3, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                />
                <h2
                  className="font-accent text-sm tracking-[0.3em]"
          ...
          >
            <p className="font-accent text-[10px] tracking-[0.4em] text-muted-foreground mb-4">
              Family Overview
            </p>
            <div className="inline-flex gap-3 flex-wrap justify-center">
              {GENERATIONS.map((gen) => {
                const count = members.filter(
                  (m) => m.generation === gen.name,
                ).length;
                return (
                  <motion.div
                    key={gen.name}
                    className="px-4 py-2.5 rounded-xl glass border border-border text-center min-w-[80px]"
